              ...
              <div className="md:flex-1 px-4">
                ...
                <div className="flex -mx-2 mb-4">
                  <div className="w-1/2 px-2">
                    <button className="w-full  py-2 px-4 rounded-full font-bold hover:text-white transition duration-700 ease-in-out  hover:bg-gray-800 dark:hover:bg-gray-700">
                      Add to Cart
                    </button>
                  </div>
                  <div className="w-1/2 px-2">
              ...
              <div className="md:flex-1 px-4">
                ...
                <ul className="flex justify-start mt-5 space-x-5 mb-6">
                  <li>
                    <a
                      href="#"
                      className="text-gray-500 hover: dark:hover:text-white dark:text-gray-400"
                    >
                      <svg
                        className="w-10 h-10"
                        fill="currentColor"
                ...
                <div className="flex justify-start gap-4 mb-6">
                  <ul className="flex gap-2 justify-center">
                    <li>
                      <svg
                        className="w-7 text-cyan-500 hover:scale-105"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 496 512"
                      >
                ...
                <div>
                  ...
                  <p className=" text-sm mt-2">
                    {plas
                      ? data.description
                      : "Another description based on plas state"}
                  </p>
                  <button
                    onClick={func}
                    className="mt-4 bg-blue-500 dark:bg-blue-700 text-white py-2 px-4 rounded-full font-bold hover:bg-blue-600 dark:hover:bg-blue-800"
                  >
                    Toggle Description
                  </button>
                </div>
            ...
            <section className="py-8 lg:py-16 antialiased">
              <div className="max-w-2xl mx-auto px-4">
                ...
                <form className="mb-6">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center mb-20 py-2.5 px-4 text-xs font-medium text-center  bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
                  >
                    Post comment
                  </button>
                </form>
                ...
                {data.reviews.map((review, index) => (
                  <article key={index} className="p-6 text-base mt-10">
                      ...
                      <div className="flex items-center">
                        <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
                          <img
                            ...
                            alt="Michael Gough"
                          />
                          <h1 className="text-gray-600 dark:text-gray-50">
                            {review.reviewerName}
                          </h1>
                        </p>
